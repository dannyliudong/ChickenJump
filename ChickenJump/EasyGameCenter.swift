    ...
    */
    ...
    class var delegate: UIViewController {
        ...
        set {
            ...
            EGC.printLogEGC("New delegate UIViewController is \(newValue)\n")
        }
    }
    ...
    func checkupNetAndPlayer() {
        dispatch_async(dispatch_get_main_queue()) {
            if self.timerNetAndPlayer == nil {
                self.timerNetAndPlayer = NSTimer.scheduledTimerWithTimeInterval(1.0, target: self, selector: "checkupNetAndPlayer", userInfo: nil, repeats: true)
            }
